...
![_images/workprocess.jpg](image/components_zg330backend_img01.jpg)
...
#### 2.3.2 userConnectNetwork 多网络输入输出连接
...
#### 2.3.3 disableMergeHardOp 关闭算子连贯执行模式
...
#### 2.3.4 disableEtmOptimize 关闭etm内存回收
