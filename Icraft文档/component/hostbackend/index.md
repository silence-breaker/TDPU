# Icraft HostBackend[#](#icraft-hostbackend "此标题的永久链接")
...
### 2.1 C++接口使用说明[#](#c "此标题的永久链接")

#### 2.1.1 创建基于HostDevice或CudaDevice的Session[#](#hostdevicecudadevicesession "此标题的永久链接")
...
#### 2.1.2 fakeQf模式[#](#fakeqf "此标题的永久链接")
...
#### 2.1.3 Utils使用方法[#](#utils "此标题的永久链接")
...
### 2.2 Python接口使用说明[#](#python "此标题的永久链接")

#### 2.2.1 创建基于HostDevice或CudaDevice的Session[#](#id3 "此标题的永久链接")
...
### 2.3 其他HostBackend接口[#](#hostbackend "此标题的永久链接")
...
## 四 错误码 errorcode[#](#errorcode "此标题的永久链接")

### 4.1 错误码说明[#](#id7 "此标题的永久链接")
